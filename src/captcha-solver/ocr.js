...
function getKeep2share(file, callback) {
    Jimp.read(file).then(image => {
        image.write('./src/captcha-solver/darknet64/temp.jpg', function () {
            let result = execSync('cd ./src/captcha-solver/darknet64 && ' + darknetExec + ' detector test data/obj.data yolov3tinyobj.cfg yolov3tinyobjLast.weights -dont_show temp.jpg');
